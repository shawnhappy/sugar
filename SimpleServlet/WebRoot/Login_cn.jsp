    ...
    <div class="web_qr_login" id="web_qr_login" style="display: block; height: 235px;">    
			...
			<div class="login_form">
               ...
               <div class="inputOuter" id="pArea">
                ...
                <input type="hidden" id="flag" name="flag" value="cn"/>
                <div style="padding-left:50px;margin-top:20px;"><input type="submit" value="登录" style="width:130px;" class="button_blue"/><a href="Register_cn.jsp" class="zcxy" target="_blank">注册</a></div> 
              </form>
           </div>
	...
	if("${loginmessage}" != ""){
		if("${loginmessage}" == "sucess" ){
			if("${authority}" == "admin"){
				...
				var url = "index_cn.jsp?name="+"${name}"+"&turn="+"${turn}"+"&minOut="+"${minOut}"+"&maxOut="+"${maxOut}"+"&target="+"${target}"+"&threshold="+"${threshold}";	
				location.href=url;
			}
