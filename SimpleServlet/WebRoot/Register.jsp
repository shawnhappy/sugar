...
<div class="login" style="margin-top:50px;">
    ...
    <div class="header">
        <div class="switch" id="switch">
			<a class="switch_btn_focus" id="switch_login" href="javascript:void(0);" tabindex="8">Registration</a><div class="switch_bottom" id="switch_bottom" style="position: absolute; width: 70px; left: 0px;"></div>
        </div>
    </div>  
  ...
  <!--注册-->
    ...
    <div class="web_login"><form name="form2" id="regUser" accept-charset="utf-8"  action="index_1" method="post">
        ...
        <ul class="reg_form" id="reg-ul">
                ...
                <li>
                    <div class="inputArea">
                        <input type="button" id="reg"  style="margin-top:10px;margin-left:85px;" class="button_blue" value="Sign up now"/> <a href="#" class="zcxy" target="_blank">Registration</a>
                    </div>
